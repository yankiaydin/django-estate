...
urlpatterns = [
    path("", views.housing_page, name="housing_page"),
    path("detail/r/<int:id>", views.housing_rent_detail, name="rent_detail"),
    path("detail/s/<int:id>", views.housing_sale_detail, name="sale_detail"),
